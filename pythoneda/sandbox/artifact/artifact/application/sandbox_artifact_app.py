...
class SandboxArtifactApp(LocalArtifactApp):
    ...
    def __init__(self):
        ...
        """
        # sandbox_artifact_banner is automatically generated by pythoneda-sandbox/python-artifact-artifact's flake.
        banner = None
        try:
            from pythoneda.sandbox.artifact.artifact.application.sandbox_artifact_banner import (

"""
pythoneda/sandbox/artifact/artifact/infrastructure/local_sandbox_artifact.py

This file defines the LocalSandboxArtifact class.
...
from pythoneda.shared.artifact.artifact import LocalArtifactArtifact
...
class LocalSandboxArtifact(LocalArtifactArtifact):
    ...
    Responsibilities:
        ...
        - React upon incoming artifact events from SandboxArtifact's dependencies.

    Collaborators:
        - pythoneda.shared.artifact.artifact.ArtifactArtifact: Common logic for Artifacts.
        - rydnr.sandbox.artifact.application.SandboxArtifactArtifactApp: To initialize this class.
    """
    ...
    def __init__(self, folder: str):
        ...
        super().__init__(
            ...
            "https://github.com/pythoneda-sandbox/python-artifact",
            License.from_id(
                Gpl3.license_type(),
                "2023",
                "rydnr",
    ...
    def url_for(self, version: str) -> str:
        ...
        :rtype: str
        """
        return f"https://github.com/pythoneda-sandbox/python-artifact-artifact/{version}?dir=python-artifact"
